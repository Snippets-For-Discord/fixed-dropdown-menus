...
![Preview](./screenshots/recording.gif)
...
```
git clone https://github.com/Snippets-For-Discord/fixed-dropdown-menus
```
...
2. After installing, head over to [this link](https://raw.githubusercontent.com/Snippets-For-Discord/fixed-dropdown-menus/main/src/support/FixedDropdownMenus.user.css).
